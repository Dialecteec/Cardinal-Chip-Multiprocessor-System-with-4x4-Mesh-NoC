...
read_verilog ./src/DW01_addsub.v;

read_verilog ./src/DW02_mult_byte.v;
read_verilog ./src/DW02_mult_fullword.v;
read_verilog ./src/DW02_mult_halfword.v;

read_verilog ./src/DW_div_byte.v;
read_verilog ./src/DW_div_doubleword.v;
read_verilog ./src/DW_div_fullword.v;
read_verilog ./src/DW_div_halfword.v;

read_verilog ./src/DW_shifter_byte.v;
read_verilog ./src/DW_shifter_doubleword.v;
read_verilog ./src/DW_shifter_fullword.v;
read_verilog ./src/DW_shifter_halfword.v;

read_verilog ./src/DW_sqrt_byte.v;
read_verilog ./src/DW_sqrt_doubleword.v;
read_verilog ./src/DW_sqrt_fullword.v;
read_verilog ./src/DW_sqrt_halfword.v;
